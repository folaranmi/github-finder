    ...
    return (
        <>
            <div className="w-full mx-auto lg:w-10/12">
                        ...
                        <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                            ...
                            {twitter_username && (
                                <div className="stat">
                                    ...
                                    <div className="stat-value text-lg">
                                    <a href={`https://www.twitter.com/${twitter_username}`} target="_blank" rel='noreferrer'>{twitter_username}</a>
                                    </div>
                                </div>
                            )}
                        </div>
                ...
                <div className="w-full  py-5 mb-6 stats rounded-lg shadow-md bg-base-100">
